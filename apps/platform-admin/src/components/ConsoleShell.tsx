...
import { NAVIGATION, SIGN_IN_URL } from "@/lib/platform";
...
export function ConsoleShell({ children }: { children: React.ReactNode }) {
  ...
  if (phase === "checking") return <Splash label="Opening the platform console…" />;
          ...
          <div className="ml-auto flex items-center gap-3">
            {session ? (
              <div className="hidden text-right sm:block">
                ...
                <p className="text-caption leading-tight text-content-muted">Platform operator</p>
              </div>
            ) : null}
            <span
              aria-hidden="true"
...
function EnterpriseSearch() {
  return (
    <form action="/security" method="get" className="max-w-md flex-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          name="q"
          type="search"
          placeholder="Search security events and denials"
