 ...
 *
 * Managers and underwriters across organisations. Same staff principal, wider permissions. Never on the public internet.
 *
  ...
  return (
    <div className="flex flex-col gap-8">
      <header className="flex flex-col gap-3">
        ...
        <h1 className="text-h1 font-bold tracking-tight">Enterprise console</h1>
        <p className="max-w-2xl text-body text-content-secondary">
          Underwriting, approvals and portfolio oversight.
        </p>
      </header>
