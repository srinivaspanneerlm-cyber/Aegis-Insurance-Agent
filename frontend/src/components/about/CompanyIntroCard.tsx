  ...
  return (
    <section className="relative px-6 py-12 z-10">
      <div className="max-w-4xl mx-auto">
        <motion.div
          whileHover={{ y: -4 }}
          className={`p-8 md:p-10 rounded-[32px] border text-center relative overflow-hidden transition-all bg-white border-royal-200 shadow-premium dark:bg-slate-900/50 dark:border-cyan-500/20 dark:shadow-[0_0_35px_rgba(6,182,212,0.05)]`}
        >
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className={`text-sm md:text-base leading-relaxed font-semibold text-slate-700 dark:text-slate-300`}>
