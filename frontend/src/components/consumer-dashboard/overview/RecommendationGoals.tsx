  ...
  return (
    <div className="space-y-4 text-left">
      <div className="flex items-center justify-between border-b border-white/5 pb-2">
        <h3 className={`font-black text-sm tracking-widest uppercase text-content`}>Personalized Protection Goals</h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className={`rounded-3xl p-6 border flex flex-col justify-between group text-slate-350 shadow-2xl hover:border-purple-550/20 transition-all text-left bg-white border-slate-200 dark:bg-slate-900/40 dark:border-white/5`}>
          <div className="space-y-4">
            ...
            <div>
              <h4 className={`font-black text-sm group-hover:text-purple-400 transition-colors leading-tight truncate text-content`}>
          ...
          <div className="pt-4 border-t border-white/5 mt-5 flex items-baseline justify-between">
            <div>
              ...
              <span className={`text-xs font-black mt-0.5 block text-content`}>₹1 Crore Cover</span>
            </div>
        ...
        <div className={`rounded-3xl p-6 border flex flex-col justify-between group text-slate-350 shadow-2xl hover:border-cyan-550/20 transition-all text-left relative bg-white border-slate-200 dark:bg-slate-900/40 dark:border-white/5`}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className={`font-black text-sm group-hover:text-cyan-400 transition-colors leading-tight truncate text-content`}>
          ...
          <div className="pt-4 border-t border-white/5 mt-5 flex items-baseline justify-between">
            <div>
              ...
              <span className={`text-xs font-black mt-0.5 block text-content`}>₹25 Lakh Cover</span>
            </div>
            <div className="text-right">
      ...
      <div className={`p-4 rounded-2xl border text-[11px] font-bold flex items-center justify-between gap-3 text-left bg-slate-100/50 border-slate-200 text-slate-500 dark:bg-white/[0.01] dark:border-white/5 dark:text-slate-500`}>
