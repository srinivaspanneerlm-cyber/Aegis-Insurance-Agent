  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <p className={`text-xs font-semibold leading-relaxed ${descClass(theme)}`}>Specify the members you seek to shelter. Aegis designs unified policy pools to cover multiple lives.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <button
          ...
          className={`p-4.5 rounded-2xl flex items-center gap-3.5 relative transition-all border text-left cursor-pointer ${familyBtnClass(theme, familyConfig.includes("spouse"))}`}
        >
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
        ...
        <button
          ...
          className={`p-4.5 rounded-2xl flex items-center gap-3.5 relative transition-all border text-left cursor-pointer ${familyBtnClass(theme, familyConfig.includes("kids"))}`}
        >
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
        ...
        <button
          ...
          className={`p-4.5 rounded-2xl flex items-center gap-3.5 relative transition-all border text-left cursor-pointer ${familyBtnClass(theme, familyConfig.includes("parents"))}`}
        >
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${
